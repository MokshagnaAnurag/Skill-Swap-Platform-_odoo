...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row justify-between w-full gap-4 pb-8 pt-4 px-2">
        <div className="space-y-2">
          ...
          <p className="text-sm mt-2 flex items-center gap-x-1">
